...
public class Aims {
    ...
    public static void main(String[] args) {
       ...
       ArrayList <Media> items = new ArrayList<>();
        ...
        bk3.addAuthor("Nguyen Van Hong");
        bk3.addAuthor("Mark Zuckerberg");
        ...
        do {
            ...
            switch (select) {
                ...
                case 0:
                    ...
                    break;
                default:
                    System.out.println("Enter incorrectly, please input again");
                    break;
            }
        } while (check);
    }
